    ...
    return(
        <div className="w-full max-w-[680px] shadow-lg border border-gray-200 rounded-[20px] p-4 flex-1 h-full">
            <div className="flex gap-4 items-center size-2/4">
                ...
                <div className="">
                    <h5 className="text-green-600 font-bold text-[18px]">Closer</h5>
            ...
            <div className="flex justify-between gap-2 flex-wrap size-2/4 w-full">
                {dataNumbers.map((item, index) => (
                    <div className="flex flex-col flex-1 min-w-[120px]" key={index}>
                        ...
                        <span className="py-1 bg-green-200 border text-gray-600 font-bold text-center text-xl rounded-lg w-full flex items-center justify-center">{item.number}</span>
                    </div>
                ))}
            </div>
        </div>
